...
class Geolocalizacion {
    constructor (){
        navigator.geolocation.getCurrentPosition(this.getValores.bind(this), this.verErrores.bind(this));
    }
    getValores(posicion){
    ...
    getMapaEstaticoGoogle(dondeVerlo){
        ...
        var zoom ="&zoom=13";
        var tamanio= "&size=1280x720";
        var marcador = "&markers=red:red%7Clabel:S%7C" + this.latitud + "," + this.longitud;
        var sensor = "&sensor=false"; 
        
        this.imagenMapa = url + centro + zoom + tamanio + marcador + sensor + apiKey;
        ubicacion.innerHTML = ubicacion.innerHTML + "<img src='"+this.imagenMapa+"'/>";
    }
}
